...
ActiveRecord::Schema.define(version: 20170729220113) do
  ...
  create_table "drafts", force: :cascade do |t|
    ...
    t.string   "token"
    t.integer  "user_id"
    t.index ["token"], name: "index_drafts_on_token", unique: true, using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "is_star_writer",         default: false
  ...
  create_table "writings", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_writings_on_slug", unique: true, using: :btree
